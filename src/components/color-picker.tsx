...
import { Copy, Info, Pipette } from "lucide-react";
    ...
    <div className="grid w-full grid-cols-1 gap-4 pt-4 md:grid-cols-4">
      <div className="col-span-1 flex flex-col gap-4 align-middle">
        ...
        <Popover>
          ...
          <PopoverContent className="flex w-full flex-col gap-4" align="start">
            <h1 className="text-center font-bold">Color Conversions</h1>
      ...
      <div className="cols-span-1 md:col-span-3">
        {image ? (
          ...
          <div className="flex w-full flex-col items-center rounded-md border border-border p-6 align-middle">
            ...
            <p className="pt-2 text-lg font-medium">No Image Uploaded</p>
            <p className="mt-4 flex items-center gap-x-2 rounded-md border border-border px-4 py-1 align-middle text-sm font-medium leading-loose text-muted-foreground">
              <Info className="h-3 w-3" />
              <span>Image is only loaded on the client</span>
            </p>
          </div>
        )}
      </div>
